...
```{r}
survey_df <- read_csv(here::here("data_private/stat113_survey_f26.csv")) |>
...
5. Confidence interval or hypothesis test for a slope in a regression model (scatterplot).

6. Confidence interval or hypothesis test for a difference in means in a regression model (side-by-side boxplots).

7. ANOVA hypothesis test (side-by-side boxplots).
...
b. ANOVA hypothesis test.

c. Confidence interval or hypothesis test for a slope.
...
g. Confidence interval or hypothesis test for a slope.
