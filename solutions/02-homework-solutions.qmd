...
library(tidyverse)
library(here)
stat113_df <- read_csv(here("data_private/stat113_survey.csv"))

ggplot(data = stat113_df, aes(x = Exercise)) + 
  geom_histogram(colour = "darkorange4", fill = "darkorange1", bins = 15) +
  theme_minimal() +
...
e. Can make either argument for this question but I would argue "Yes", you can make this extension because the relationship between whether or not a student plays a sport and their award preference is probably similar for students who choose not to take STAT 113. So, though we have a convenience sample, the association we are attempting to measure should be similar for students not taking STAT 113.
